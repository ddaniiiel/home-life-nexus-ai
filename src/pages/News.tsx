  ...
  useEffect(() => {
    const mockNews: NewsItem[] = [
      ...
      },
      {
        ...
        date: '2025-04-10',
        category: 'taxes',
        imageUrl: 'https://source.unsplash.com/random/800x600?renovation',
        url: '#',
        isSaved: false,
      },
      {
      ...
      },
      {
        ...
        date: '2025-03-25',
        category: 'smart-home',
        imageUrl: 'https://source.unsplash.com/random/800x600?automation',
        url: '#',
        isSaved: false,
      },
      {
        ...
        date: '2025-03-28',
        category: 'mortgage',
        imageUrl: 'https://source.unsplash.com/random/800x600?mortgage',
        url: '#',
        isSaved: true,
      },
      {
